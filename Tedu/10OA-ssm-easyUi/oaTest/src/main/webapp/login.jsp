                            ...
                            <form method="post" action="doLogin">
                                ...
                                <div class="ad-auth-form">
                                    <div class="ad-auth-feilds mb-30">
                                        <input type="text" name="username" placeholder="用户名" class="ad-input">
                                    ...
                                    <div class="ad-auth-feilds">
                                        <input type="password" name="password" placeholder="密码" class="ad-input">
                                        <div class="ad-auth-icon">
                                ...
                                <div class="ad-auth-btn">
                                    <button href="javascript:void(0);" class="ad-btn ad-login-member">登陆</button>
                                </div>
                                <p class="ad-register-text">没有账号？ <a href="register.html">点击注册</a></p>
                            </form>
                        </div>
                    </div>
                </div>
